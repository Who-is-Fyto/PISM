...
public class HeaderBar extends JPanel {
    ...
    private void initUI(String portalTitle) {
        ...
        if ("ADMIN".equalsIgnoreCase(role)) {
            lblRoleBadge.setBackground(new Color(224, 231, 255));
            lblRoleBadge.setForeground(new Color(67, 56, 202));
        } else {
            lblRoleBadge.setBackground(new Color(220, 252, 231));
            lblRoleBadge.setForeground(new Color(21, 128, 61));
        }
